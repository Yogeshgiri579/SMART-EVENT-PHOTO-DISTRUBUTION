  ...
  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between relative">
        ...
        {user && (
          <form onSubmit={handleSearch} className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[200px] md:max-w-xs xl:max-w-md hidden sm:block z-0">
        ...
        <nav className="items-center gap-6 hidden md:flex relative z-10">
          <Link 
            to="/" 
